...
public class TestDataset {
    public static void main(String[] args) {
        ...
        double exposureMs = 50.0;
        double xyMoveMs = 150.0;
        ...
        try {
            ds.initialize(width, height, pixType, bitDepth, 1, pixSizeUm, new JSONObject());
        ...
        } catch (DatasetException | InterruptedException | IOException | JSONException e) {
            e.printStackTrace();
        }
    }
}
